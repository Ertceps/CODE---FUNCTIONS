...
# LCD mapping
LCD_RS = 18  # Blue cable - Screen Pin 4
LCD_E  = 23  # Green cable - Screen Pin 6
LCD_D4 = 12  # Yellow cable - Screen Pin 11
LCD_D5 = 16  # Yellow cable - Screen Pin 12
LCD_D6 = 20  # Yellow cable - Screen Pin 13
LCD_D7 = 21  # Yellow cable - Screen Pin 14
...
def main(state):
    ...
    if state == "START":
        ...
        time.sleep(2)
        lcd_string_fix("VACUUM CONTROLLER", LCD_LINE_2)
...
class ThreadLCD(threading.Thread):
    ...
    def __init__(self, threadID, name, counter, state):
